"""Development-only copy: material-anchored Stockfish fit, with the two weights whose
fitted sign contradicts chess clamped to zero.
...
# 3. king safety
# 4. center control
MOBILITY_WEIGHT = 3.060377
MATERIAL_WEIGHT = 1.0
KING_SAFETY_WEIGHT = 18.119806
CENTER_WEIGHT = 1.161908
ATTACK_WEIGHT = 0.0
PASSED_PAWN_WEIGHT = 37.67119
HANGING_PIECE_WEIGHT = 9.007422
PAWN_STRUCTURE_WEIGHT = 8.132771
THREAT_WEIGHT = 9.007422
SPACE_WEIGHT = 0.0
